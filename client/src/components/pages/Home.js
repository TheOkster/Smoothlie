              ...
              {userId ? (
                <>
                  <Link to={{ pathname: "/selecttasks" }}>
                    {" "}
                    {/* need to fix this later; this is going to redirect to another page depending on whether you've selected tasks before*/}
                    <button className="Button">Welcome! Click here to begin.</button>
                  </Link>
